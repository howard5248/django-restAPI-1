...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short(self):
        '''Test that the password must be moree than 5 characters'''
    ...
    def test_create_token_invalid_credentials(self):
        '''Test that token is not ceated if invalid credentials are given'''
    ...
    def test_create_token_no_user(self):
        '''Test that token is not creted if user doesn't exits'''
        payload = {'email': 'test@gmail.com', 'password': 'testpassword'}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_pose_me_not_allowed(self):
    ...
    def test_update_user_profile(self):
        '''Test upateing the user profile for authentication'''
